...
const Contact = () => {
    return (
        <div className=' md:container m-auto' id='contact'>
            <div className='md:flex gap-5 my-4 flex-wrap  m-auto relative items-center'>
                ...
                <div className='md:w-5/12 ml-auto mt-5'>
                    <img src={loader} alt="background loader" className='absolute left-[15rem] z-[-1] top-0 hidden md:block' />
                    <div className='text-white'>
                        <div className="contact-text flex gap-5 items-center">
                            <div className='bg-[#F37A23] rounded-full p-2'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-phone-vibrate" viewBox="0 0 16 16">
                        ...
                        <div className="contact-text flex gap-5 items-center mt-5">
                            <div className='bg-[#F37A23] hover:bg-[#f5b98f] rounded-full p-2'>
                            ...
                            <div>
                                <p>Email</p>
                                <p>promiseorung@gmail.com</p>
                            </div>
                        </div>
                        <div className="contact-text flex gap-5 items-center mt-[3rem]">
                            <div className='bg-[#F37A23] hover:bg-[#ffffff] rounded-full p-2'>
                                <a href="https://www.instagram.com/promiseorung/" className='hover:text-[#183eff]' rel='noreferrer' target="_blank">
                            ...
                            <div className='bg-[#F37A23] hover:bg-[#ffffff] rounded-full p-2'>
                                <a href="https://twitter.com/Promiseorung" className='hover:text-[#32b0ff]' rel='noreferrer' target="_blank">
                            ...
                            <div className='bg-[#F37A23] hover:bg-[#ffffff] rounded-full p-2'>
                                <a href="https://www.instagram.com/promiseorung/" className='hover:text-[#f4724b]' rel='noreferrer' target="_blank">
                            ...
                            <div className='bg-[#F37A23] hover:bg-[#f3f3f3] rounded-full p-2'>
                                <a href="https://web.facebook.com/magnificentorung" className='hover:text-[#0800ff]' rel='noreferrer' target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
                                        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                                    </svg>
                                </a>
                            </div>
                            <div className='bg-[#F37A23] hover:bg-[#f7f7f7] rounded-full p-2'>
                                <a href="https://wa.me/8060569196" className='hover:text-[#237642]' rel='noreferrer' target="_blank">
